...
echo "  docker-compose -f docker-compose.t3small.yml restart"
echo ""
echo "Or do a full restart to pick up latest code:"
echo "  docker-compose -f docker-compose.t3small.yml down"
echo "  docker-compose -f docker-compose.t3small.yml up -d"
